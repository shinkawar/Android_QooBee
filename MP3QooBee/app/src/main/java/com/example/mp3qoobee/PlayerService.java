...
public class PlayerService extends Service {
    ...
    public void onCreate() {
        ...
        notificationManager =new PlayerNotificationManager.Builder(this, notificationId, channelId)
                ...
                .setSmallIconResourceId(R.drawable.small_icon_notifi)
                .setChannelDescriptionResourceId(R.string.app_name)
                .setNextActionIconResourceId(R.drawable.icon_skip_next)
                .setPreviousActionIconResourceId(R.drawable.icon_skip_previous)
                .setPauseActionIconResourceId(R.drawable.icon_pause)
                .setPlayActionIconResourceId(R.drawable.icon_play)
                .setStopActionIconResourceId(R.drawable.icon_close)
