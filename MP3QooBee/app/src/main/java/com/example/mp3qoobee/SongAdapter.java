...
public class SongAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //ấn item trên list view sẽ tạo ra các sự kiện như get player view, play nhạc cần lệch record
    @Override
    ...
    private List<MediaItem> getMediaItems() {
        ...
        for (Song song : songs){
            MediaItem mediaItem = new MediaItem.Builder()
                    .setUri(song.getUri())
                    .setMediaMetadata(getMediadata(song))
                    .build();
    ...
    private MediaMetadata getMediadata(Song song) {
